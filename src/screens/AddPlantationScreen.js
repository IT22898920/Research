...
export default function AddPlantationScreen({navigation}) {
      ...
      try {
        const granted = await PermissionsAndroid.request(
          PermissionsAndroid.PERMISSIONS.ACCESS_FINE_LOCATION,
          {
            ...
            message: 'This app needs access to your location to set plantation location.',
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      Alert.alert('Success', 'Plantation created successfully!', [
        {
          text: 'OK',
      ...
      Alert.alert('Error', error.message || 'Failed to create plantation');
    } finally {
      setSaving(false);
    }
  };
      ...
      <ScrollView style={styles.content} contentContainerStyle={styles.contentContainer}>
        ...
        <TouchableOpacity
          ...
          {saving ? (
            ...
            <Text style={styles.saveButtonText}>💾 Create Plantation</Text>
          )}
        </TouchableOpacity>
      </ScrollView>
